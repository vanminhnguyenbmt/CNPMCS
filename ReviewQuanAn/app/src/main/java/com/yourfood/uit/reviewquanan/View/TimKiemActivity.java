...
import com.yourfood.uit.reviewquanan.Controller.TimKiemController;
...
public class TimKiemActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        searchEditText.setHint("Nhập tên quán ăn");
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(final DataSnapshot dataSnapshotQuanAn) {
                            ...
                            if(dataSnapshotQuanAn.getValue() != null){
                                ...
                                Toast toast= Toast.makeText(TimKiemActivity.this, "Không tìm thấy dữ liệu", Toast.LENGTH_SHORT);
